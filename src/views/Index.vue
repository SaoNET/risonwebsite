            ...
            <div class="md-layout">
              <div class="md-layout-item md-medium-size-33 md-small-size-100">
                <div class="info">
                  ...
                  <p>
                    Automate working processes and improve efficient.
                  </p>
                </div>
              </div>
              <div class="md-layout-item md-medium-size-33 md-small-size-100">
              ...
              <div class="md-layout-item md-medium-size-33 md-small-size-100">
                <div class="info">
                  ...
                  <p>
                    All information is secure and confident.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div class="md-layout">
            <div class="md-layout-item md-size-66 md-xsmall-size-100 mx-auto">
              ...
              <h4 class="text-center description">
                Get more information and answers on all your questions.
              </h4>
